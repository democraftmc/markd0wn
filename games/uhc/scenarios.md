...
## ✨️ Hastey Boys
Tout les objets que vous construisez sont enchantés Incassable et Efficacité 3
## 🎏 Lucky Leaves
Les arbres ont 0,5% de chance de dropper une pomme en or
## 🎁 Bleeding Sweets
À sa mort, le joueur drop 1 diamant, 5 lingots d'or, 1 livre, 2 ficelles et 16 flèches.
## 🔮 Switcheroo
Si vous touchez quelqu'un avec une flèche, vous échanger de position avec lui
## 🧱 Vein Miner
Miner un minerais minera le filon entier
## 🐉 DragonRush
La première équipe a tuer l'enfer dragon gagne ! Il y a un portail au 0-0
## ❤️‍🔥 Love At First Sight
Avec ce scénario, vous ne pouvez pas choisir vos équipe au début de la partie. Vous devez cliquer sur quelqu'un en jeu pour être dans la même équipe.
## ⏳️Fast Leaves Decay
Les feuilles des arbres disparaissent presque instantanément.
## ☄️ Fast Smelting 
Les objets cuisent 5 foit plus vite.
## 🌀 Super Heroes
Chaque joueur recoit un effet au hasard entre rapidité 1, force 1, résistance 2, invisibilité, boost de saut 4 ou 6 cœurs supplémentaires.
## 🥷 Anonymous 
Les noms des joueurs sont illisibles
## 🎣 Gone Fishing
Au debut de la partit, chaquz joueur recoit une canne à pêche chance de la mer 3.
## 🌌 Infinite Enchants
Vous recevez 64 tables d'enchantement, 64 enclume, 64 blocs de lapis et plein d'expérience (mais genre beaucoup)
## 👨‍👩‍👦 Children Left Unattended
Quand un membre de votre équipe meurt, vous recevez une potion de rapidité et une potion de vitesse
## 🤫 Silent Night
La nuit, les messages et les nametag ne sont pas visibles.
## 🌓 PermaKill
